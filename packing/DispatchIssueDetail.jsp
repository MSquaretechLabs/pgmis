...
function validateFormFields()
{
 ...
 if(document.SOMaster.display.value != "display")
 {
   ...
   {
   reason+="Please Enter Dispatch Date .\n";
...
{   
 ...
 String soNo="",customerName="",styleName="",expDlvDate="";
 
 String showDtl= "SELECT c.NAME CUSTOMER, concat(SO_NO,'-','-dated.',DATE_FORMAT(SO_DATE,'%d-%b-%Y')) SO_NO,DATE_FORMAT(EXP_DLV_DATE,'%d-%b-%Y') EXP_DLV_DATE "+
 ...
 if(display.equalsIgnoreCase("save"))
 {
    ...
    int maxId=0;
     ...
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_dispatch_master";
     ...
     if(maxId==0)maxId=1;      
      ...
      String sqlInsert="INSERT INTO t_dispatch_master"+
      " (ID,SO_DTL_ID,TLR_ID,ES_R,S_R,M_R,L_r,XL_R,XXL_r,XXXL_R,FREE_R,REC_DATE,REC_REMARKS)"+
      " VALUES "+
     ...
     // check data availability in so_style_availability
      ...
      //out.println(chkSql);
       ...
       String sqlUpdateStock2="UPDATE t_so_style_tracking set DISPATCHED= '"+issueStatus+"' "+
     ...
     message= " Dispatch Details have been updated successfully.";
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Enter Dispatch Details</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SOMaster">
                      ...
                      <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label">Expected Delivery Date</label>
                                    <div class="col-sm-6">
                                             <label for="selector1" class="col-sm-6 control-label"><%=expDlvDate%></label>
                                    </div>
...
String bImageName ="",id="",stName="",fab="",descr="",fImage="",bImage ="",monthYear="";
    ...
    String fullIssueStatus="N";
                String fullIssueSql="SELECT DISPATCHED FROM t_so_style_tracking where SO_ID="+mast.getSo()+" "+
                " and STYLE_ID="+style+" ";
                
                rs= st.executeQuery(fullIssueSql);
                
                if(rs.next()){
                fullIssueStatus= rs.getString("DISPATCHED"); 
                }
...
<div class="form-group">                        
           ...
           <%  
            ...
            <%
               ...
               while(rs.next())
                      ...
                      %>
                       ...
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><B>Qty. received from Tailoring Dept.</th>
                           <td align=center><%=es%></td>
                          <td align=center><%=s%></td>
                          <td align=center><%=m%></td>
                          <td align=center><%=l%></td>
		    ...
		    <%
                     ...
                     " SUM(ifnull(t.ES_R,0))ES, SUM(ifnull(t.S_R,0))S,SUM(ifnull(t.M_R,0))M,SUM(ifnull(t.L_R,0))L,"+
                      " SUM(ifnull(t.XL_R,0))XL,SUM(ifnull(t.XXL_R,0))XXL,SUM(ifnull(t.XXXL_R,0))XXXL,SUM(ifnull(t.FREE_R,0))FREE,"+
                     " REC_REMARKS REMARKS "+
                     " from t_so_details SOD, t_so_master SO, t_packing_issue t "+
                     " WHERE SOD.SO_ID= SO.ID "+
                     " AND SOD.ID="+soDtlId+" "+
                     " AND t.SO_DTL_ID= SOD.ID"+
                      " AND SOD.SO_ID="+mast.getSo();
                 ...
                 rs = st.executeQuery(sql3);
                 cnt=0;
                 int esR=0,sR=0,mR=0,lR=0,xlR=0,xxlR=0,xxxlR=0,freeR=0;
               while(rs.next())
                       {
                       ...
                       ++cnt;
                        ...
                        soDtlId2= rs.getString("SO_DTL_ID");if(soDtlId2==null)soDtlId2="";
                          esR= rs.getInt("ES");
                           ...
                           xlR= rs.getInt("XL");
                           xxlR= rs.getInt("XXL");
                           xxxlR= rs.getInt("XXXL");
                           freeR= rs.getInt("FREE");
                        remarks2=  rs.getString("REMARKS");if(remarks2==null)remarks2="";
                        
                      %>
                    
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><B>Qty. already sent for Packing</th>
                           <td align=center><%=esR%></td>
                          <td align=center><%=sR%></td>
                          <td align=center><%=mR%></td>
                          <td align=center><%=lR%></td>
                          <td align=center><%=xlR%></td>
                          <td align=center><%=xxlR%></td>
                             <td align=center><%=xxxlR%></td>
                          <td align=center><%=freeR%></td>
                           <td align=left><%=remarks2%></td>
		    ...
		    <%
                     ...
                     " SUM(ifnull(t.ES_R,0))ES, SUM(ifnull(t.S_R,0))S,SUM(ifnull(t.M_R,0))M,SUM(ifnull(t.L_R,0))L,"+
                      " SUM(ifnull(t.XL_R,0))XL,SUM(ifnull(t.XXL_R,0))XXL,SUM(ifnull(t.XXXL_R,0))XXXL, SUM(ifnull(t.FREE_R,0))FREE,   "+
                     " REC_REMARKS REMARKS "+
                     " from t_so_details SOD, t_so_master SO, t_dispatch_master t "+
                     " WHERE SOD.SO_ID= SO.ID "+
                     " AND SOD.ID="+soDtlId+" "+
                     " AND t.SO_DTL_ID= SOD.ID"+
                      " AND SOD.SO_ID="+mast.getSo();
               ...
               while(rs.next())
                      ...
                      %>
                       ...
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><B>Qty. already Dispatched</th>
                           <td align=center><%=esR%></td>
                          <td align=center><%=sR%></td>
                          <td align=center><%=mR%></td>
                          <td align=center><%=lR%></td>
		    ...
		    <%
                    ...
                    <%
                     ...
                     // out.println(mast.getTypeCheck());
                      ...
                      %>   
  <tr>
    <td align="center"><b><font color="Red">Enter Qty. to be Dispathed</b></td>
         <td>
  ...
  <td>
    ...
    <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Dispatch Date</label>
                                    <div class="col-sm-4">
      ...
      <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Check -if full material is dispatched for the selected style</label>
                                    <div class="col-sm-1">
