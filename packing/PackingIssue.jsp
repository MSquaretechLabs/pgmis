...
if(validateForm())
    { 
     ...
     var customer= document.SOMaster.customer.value;
     document.location.href="PackingIssueDetail.jsp?soDtlId="+soDtlId+"&so="+so+"&customer="+customer+"";
...
<div id="wrapper">
    ...
    <h4>Details of Material Received in Checking Section</h4>
                  <div class="progress">
...
" t_so_combo_details soc , t_so_master so, t_so_details sod, t_tailor_receive t "+
...
String bImageName ="",id="",stName="",fab="",descr="",fImage="",bImage ="",monthYear="";
           ...
           <%  
             ...
             " t.REC_REMARKS,DATE_FORMAT(t.REC_dATE,'%d-%b-%Y') REC_DATE"+
              ...
              String trClass="info",remarks="",issueDate="",expRecDate="";
               ...
               while(rs.next())
                       ...
                       ++cnt;
                        ...
                        remarks=  rs.getString("REC_REMARKS");if(remarks==null)remarks="";
                        issueDate=  rs.getString("REC_DATE");if(issueDate==null)issueDate="";
