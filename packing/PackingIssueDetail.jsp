...
{   
 ...
 if(display.equalsIgnoreCase("save"))
 {
    ...
    int maxId=0;
     ...
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_packing_issue";
     ...
     if(maxId==0)maxId=1;      
      ...
      String sqlInsert="INSERT INTO t_packing_issue"+
     ...
     // check data availability in so_style_availability
      ...
      //out.println(chkSql);
       ...
       String sqlUpdateStock2="UPDATE t_so_style_tracking set PACK_ISSUED= '"+issueStatus+"' "+
     ...
     message= " Selected Item has been sent to Packaging Department successfully.";
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Issue Material to Packaging Department (After Checking)</h4>
                </div>
                <%
...
String bImageName ="",id="",stName="",fab="",descr="",fImage="",bImage ="",monthYear="";
    ...
    String fullIssueStatus="N";
                String fullIssueSql="SELECT PACK_ISSUED FROM t_so_style_tracking where SO_ID="+mast.getSo()+" "+
                " and STYLE_ID="+style+" ";
                
                rs= st.executeQuery(fullIssueSql);
                
                if(rs.next()){
                fullIssueStatus= rs.getString("PACK_ISSUED"); 
                }
...
<div class="form-group">                        
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
           ...
           <%  
		    ...
		    <%
                    ...
                    %>
                     <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><B>Qty. Remaining/Rejected</th>
                           <td align=center><%=es-esR%></td>
                          <td align=center><%=s-sR%></td>
                          <td align=center><%=m-mR%></td>
                          <td align=center><%=l-lR%></td>
                          <td align=center><%=xl-xlR%></td>
                          <td align=center><%=xxl-xxlR%></td>
                            <td align=center><%=xxxl-xxxlR%></td>
                              <td align=center><%=free-freeR%></td>
                           <td align=left></td>
                    <%
                     ...
                     // out.println(mast.getTypeCheck());
                      ...
                      %>   
  <tr>
    <td align="center"><b><font color="Red">Enter Qty. to be issued for Packing</b></td>
         <td>
  ...
  <td>
    ...
    <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Date of Issuing Material for Packing</label>
                                    <div class="col-sm-4">
      ...
      <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Check -if full packing is received for the selected style</label>
                                    <div class="col-sm-1">
    ...
    <div class="form-group">                        
      ...
      <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_5 btn-lg btn-warning warning_11" onclick="window.location.href='PackingIssue.jsp'">Back</button> 
                                 </p>
                            </div>
