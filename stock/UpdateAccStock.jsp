...
function validateFormFields()
{
 ...
 if(document.SOMaster.display.value != "display")
 {
   ...
   if(document.SOMaster.acc.value=="0")
   {
   reason+="Please Select Accessory .\n";
   }else if(document.SOMaster.accType.value=="0")
   {
   reason+="Please Select Type .\n";
   }else if(document.SOMaster.accSubType.value=="0")
   {
   reason+="Please Select Sub Type.\n";
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String acc= request.getParameter("acc"); if(acc==null)acc="0";
     String accType= request.getParameter("accType"); if(accType==null)accType="0";
     String rackNo= request.getParameter("rackNo"); if(rackNo==null)rackNo="";
        
     String accSubType= request.getParameter("accSubType");
    
     boolean dataPresent=false;
     float qtyAvail=0;
      
      String chkSql= "SELECT QTY FROM t_acc_stock_master "+
      " where SUB_TYPE_ID="+accSubType+"";
      //out.println(chkSql);
       ...
       String sqlUpdateStock="UPDATE t_acc_stock_master set QTY= "+qty+" ,RACK_NO='"+rackNo+"' "+
       " where SUB_TYPE_ID="+accSubType+"";
       ...
       }else
       {
         ...
         String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_acc_stock_master";
        ...
        String sqlInsert="INSERT t_acc_stock_master (ID,SUB_TYPE_ID,QTY,RACK_NO)VALUES"+
        "("+maxId+", "+accSubType+", "+qty+",'"+rackNo+"')";
...
<div id="wrapper">
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Accessory Stock</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
            ...
            <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Select Type</label>
                                    <div class="col-sm-4">
   ...
   <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Select Sub Type</label>
                                    <div class="col-sm-4">
    ...
    //check quantity available in stock
     ...
     if(!mast.getAccSubType().equalsIgnoreCase("0"))  
     {
     
     
     
         
        String chkQtySql="SELECT ifnull(QTY,0) QTY, RACK_NO FROM t_acc_stock_master "+
        " where SUB_TYPE_ID="+mast.getAccSubType()+"";
