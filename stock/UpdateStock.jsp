...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     float qtyAvail=0;
      ...
      String chkSql= "SELECT QTY FROM t_stock_master where FABRIC_ID="+fab+" AND VAR_ID="+var+" AND"+
      "  TYPE_CHECK='"+tempTypeCheck+"' AND TYPE_ID="+tempTypeId+"";
      //out.println(chkSql);
       ...
       String sqlUpdateStock="UPDATE t_stock_master set QTY= "+qty+" ,RACK_NO='"+rackNo+"' "+
       " where FABRIC_ID="+fab+" AND VAR_ID="+var+" AND"+
      "  TYPE_CHECK='"+tempTypeCheck+"' AND TYPE_ID="+tempTypeId+"";
      // out.println(sqlUpdateStock);
       ...
       }else
       {
        ...
        "("+maxId+", "+fab+", "+var+", '"+tempTypeCheck+"',"+tempTypeId+","+qty+",'"+rackNo+"')";
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Stock</h4>
                </div>
                <%
   ...
   <div class="form-group">
    ...
    //check quantity available in stock
     ...
     if(!printT.equalsIgnoreCase("0"))  
     {
        ...
        String chkQtySql="SELECT ifnull(QTY,0) QTY, RACK_NO FROM t_stock_master where VAR_ID="+mast.getVar()+" "+
