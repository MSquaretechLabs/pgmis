...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                  <h1>
                    <span class="label btn_6 label-success">Receive Ready Material from Printer</span>  
                    </h1>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SendToPrinter" action="ReceiveAtInspFromPrinterDetail.jsp">
      ...
      String dtlSql1="",dpId="";
      String fabName="",varName="",remarks="",sentDate="",rcvdDate="",printerRemarks="",printName="",varId="0";
          float QtyOrdered=0,qtySent=0,qtyRcvd =0,qtySentToInsp=0,qtyShrink=0,qtyToBeSent=0,qtyPending=0;
...
<%
  ...
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,printer.NAME PRINTER_NAME,p.QTY, pd.QTY_SENT,i.QTY_RCVD,"+
   " ifnull(pd.QTY_SHRINK,0) QTY_SHRINK,"+
  ...
  " and i.STATUS='S' and i.QTY_INSPECTED is null and pd.TYPE_CHECK='Print' order by i.SENT_DATE ASC";
    //out.println(dtlSql1);
		      ...
		      <thead>
		        <tr>
		          ...
		          <th>Fabric & Variety</th>
                          ...
                          <th>Qty. <br> sent from Printer (in Meters)(a)</th>
                          <th>Material Sent Date</th>
                          
                          <th> Total Qty. <br> sent for inspection (b)</th>
                        <!--  <th>Qty. to be sent from Printer(c=a-b)</th>-->
                              <th>Total Shrink Qty.</th>
                          <th>Supplier Remarks</th>
                          <th>Printer Remarks</th>
		        </tr>
		      </thead>
		      <tbody>
                      <%
                        ...
                        qtyPending= rs.getFloat("QTY_PENDING");
                          qtyShrink= rs.getFloat("QTY_SHRINK");
		          ...
		          <td align=right><%=QtyOrdered%></td>
                         ...
                         <td align=left><%=qtyShrink%></td> 
                          <td align=left><%=remarks%></td>
                           <td align=left><%=printerRemarks%></td>
