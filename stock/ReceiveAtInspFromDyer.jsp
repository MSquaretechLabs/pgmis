...
<%
  ...
  " and i.STATUS='S' and i.QTY_INSPECTED is null  and pd.TYPE_CHECK='Plain'  order by i.SENT_DATE ASC";
    //out.println(dtlSql1);
		      ...
		      <thead>
		        <tr>
		          ...
		          <th>Fabric & Variety</th>
                          ...
                          <th>Qty. <br> sent for inspection (b)</th>
                         <!-- <th>Qty. to be sent from Dyer(c=a-b)</th>-->
