...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
		     <div class="panel-heading">
                    <h4 class="panel-title">Plain/ Print Material Stock</h4>
                </div>
                    <%
                    
                    String sql= "SELECT F.NAME FAB, V.NAME VAR, S.TYPE_CHECK, SUM(S.QTY) QTY"+
      ...
      <div class="col_1">
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
		    <div class="panel-heading">
                    <h4 class="panel-title">Grey Material Stock</h4>
                </div>
                    <%
                    
                    sql= "SELECT F.NAME FAB, V.NAME VAR,  SUM(S.QTY) QTY"+
                    " FROM t_gm_stock_master S, t_fabric_master F, t_var_master V "+
                    " WHERE S.VAR_ID= V.ID AND V.FABRIC_ID= F.ID"+
                    " GROUP BY F.NAME, V.NAME ";
                   // out.println(sql);
