...
{   
 ...
 String dyerName="";
 if(display.equalsIgnoreCase("display"))action="StockAccReport.jsp";else action="StockAccReport.jsp";
// out.println(display);
     ...
     <!-- Navigation -->
      ...
      <div class="col_1">
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SendToDyer" action="StockAccReport.jsp">
                     <input type="HIDDEN" name="display" value=""></input>
                  
                    <center><a href="javascript:PrintThisPage();">Print</a></center>  
                    <div  id="print_content">
                   <h4 class="panel-title">Accessories Stock Summary  Report</h4><br>
                  
<div class="form-group">
                            
                                    <label for="selector1" class="col-sm-2 control-label"> Accessory</label>
...
<%
    ...
    String sql= "SELECT A.ID ACC_ID, A.NAME ACC, T.ID TYPE_ID,T.NAME TYPE, ST.NAME SUB_TYPE, SUM(S.QTY) QTY"+
                    " FROM t_acc_stock_master S, t_acc_type_master T, t_acc_sub_type_master ST,t_acc_master A "+
                    " WHERE S.SUB_TYPE_ID= ST.ID AND ST.TYPE_ID= T.ID AND T.ACC_ID= A.ID"+
                    " AND A.ID="+mast.getAcc()+" "+
                    " GROUP BY A.NAME, T.NAME,ST.NAME ";
    
    rs= st.executeQuery(sql);
                    String acc="",accId="",type="",subType="",typePrvs ="";
		      ...
		      <tbody>
                      ...
                      String accPrvs="";
                       ...
                       if(!type.equalsIgnoreCase(typePrvs) && cnt!=1)
                          {
                         %>
		        ...
		        <td scope="row">Sub Total</td>
		          ...
		          <th scope="row"><%= cnt%></th>
                          ...
                          <%
                          if(!type.equalsIgnoreCase(typePrvs))
                          {
