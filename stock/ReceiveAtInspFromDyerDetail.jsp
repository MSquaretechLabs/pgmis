...
function validateFormFields()
{
 ...
 {
   var reason = "";
   var qtySentForInspTT= document.SendToDyer.qtySentForInsp.value;
   var qtyInspTT= document.SendToDyer.qtyInsp.value;
   var qtyBackTT= document.SendToDyer.qtyBack.value;
   var qtyRjTT= document.SendToDyer.qtyRj.value;
   ...
   }else if(document.SendToDyer.qtyBack.value=="")
   {
   reason+="Rejected Qty Sent Back can not be blank. Enter Zero if not applicable.\n";
   }else if(document.SendToDyer.qtyPuse.value=="")
   {
...
function calRJ()
  ...
  var qtySentForInspT= document.SendToDyer.qtySentForInsp.value;
  var qtyInsp= document.SendToDyer.qtyInsp.value;
  var rj= Number(qtySentForInspT)-Number(qtyInsp);
  document.SendToDyer.qtyRj.value=rj;
...
{   
  ...
  if(display.equalsIgnoreCase("save"))
 {
     ...
     " QTY_INSPECTED="+qtyInsp+", QTY_WASH="+qtyWash+",QTY_RJ="+qtyRj+", REASON='"+reason+"', INSP_REMARKS='"+remarks+"',"+
     " STATUS='R', QTY_SENT_BACK="+qtyBack+",QTY_PUSE="+qtyPuse+" where ID="+inspDtlId+"";
...
<%
  ...
  " and i.STATUS='S' and pd.TYPE_CHECK='Plain' and i.ID="+inspDtlId+" order by i.SENT_DATE ASC";
    //out.println(dtlSql1);
    ...
    String remarks2="",dyerRemarks="";
                       ...
                       %>
                          ...
                          <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty. sent from Dyer (in Meters)(a) : </b><%= qtyRcvd%></label>
                         ...
                         <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty.  sent for inspection (b) : </b><%= qtySentToInsp%></label>
                                    <input type=hidden name="qtySentForInsp" value="<%=qtyRcvd%>">
                                    <label for="selector1" class="col-sm-4 control-label"><b>Dyer Remarks: </b><%=dyerRemarks%></label>
