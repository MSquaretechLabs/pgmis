     ...
     <!-- Navigation -->
      ...
      <div class="col_1">
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SendToDyer" action="ReceiveAtStockGMDetail.jsp">
...
<%
    int count=1;
    int cnt=0;
    String trClass="info", poNo="", poGmId="0";
    
    // get var id
    
   
  dtlSql1 = "SELECT gm.ID PO_GM_ID, concat(pm.PO_NO,'-',s.NAME,'-dated.',DATE_FORMAT(PO_DATE,'%d-%b-%Y')) PO_NO, "+
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,p.QTY, gm.QTY_SENT"+
  ...
  dtlSql1+= " order by M_SENT_DATE ASC";
   //out.println(dtlSql1);
    ...
    <div class="col-md-12 span_3">
		  <div class="bs-example1" data-example-id="contextual-table">
		      ...
		      <tbody>
		          ...
		          <td scope="row"><%= cnt%></td>
                          <td scope="row" valign=top><div class="radio-inline"><label><input type="radio" name="poGmId" value=<%=poGmId%>></label></div></th>
