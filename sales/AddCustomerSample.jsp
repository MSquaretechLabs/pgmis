...
function validateFormFields()
{
 ...
 if(document.POMaster.display.value != "display")
 {
   ...
   if(document.POMaster.print.value=="0")
   {
   reason+="Please Select Print/Plain Name/Code .\n";
   }else if(document.POMaster.printPos.value=="")
   {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlInsert="INSERT INTO t_style_details(ID,STYLE_ID,TYPE_CHECK,TYPE_ID, PRINT_POSITION, ES,S,M,L,XL,XXL,REMARKS)"+
      " VALUES "+
     " ("+maxId+","+style+",'"+typeCheck+"','"+print+"','"+printPos+"', "+esTemp+","+sTemp+","+mTemp+","+lTemp+","+xlTemp+","+xxlTemp+",'"+remarks+"')"; 
     //out.println(sqlInsert);
    
     int x=st.executeUpdate(sqlInsert);
     message= "New Print/ Plain entry has been added with selected style successfully.";
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Prints in Style</h4>
                </div>
                <%
  ...
  " FROM t_product_master P, t_product_sub_master PS,t_customer_master C, t_style_master S  "+
    ...
    %>
        ...
        <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><img src="/pgmis/docs/styles/<%=fImage%>" alt=""/>
       ...
       <div class="form-group">
                                    ...
                                    <div class="col-sm-6"><img src="/pgmis/docs/styles/<%=bImage%>" alt=""/>
...
<div class="form-group">                        
    <div class="col-md-12 span_3">
		  <div class="bs-example1" data-example-id="contextual-table">
           ...
           String  sql =" SELECT SD.TYPE_CHECK,PRINT.NAME PRINT_NAME,SD.PRINT_POSITION, "+
             " ES,S,M,L,XL,XXL, REMARKS "+
             " from t_style_master S, t_style_details SD , t_print_master PRINT "+
             " WHERE SD.STYLE_ID= S.ID AND SD.TYPE_ID= PRINT.ID"+
             " AND SD.TYPE_CHECK='Print' AND SD.STYLE_ID="+mast.getStyle();
             
              sql+=" union SELECT SD.TYPE_CHECK,PRINT.NAME PRINT_NAME,SD.PRINT_POSITION, "+
             " ES,S,M,L,XL,XXL, REMARKS "+
             " from t_style_master S, t_style_details SD , t_plain_master PRINT "+
             " WHERE SD.STYLE_ID= S.ID AND SD.TYPE_ID= PRINT.ID"+
             " AND SD.TYPE_CHECK='Plain' AND SD.STYLE_ID="+mast.getStyle();
             //out.println(sql);
             
                    int count=1;
                    rs= st.executeQuery(sql);
                    String typeCheck="",printName="",printPos="",fold="",remarks="";
                    float es=0,s=0,m=0,l=0,xl=0,xxl=0;
                    int cnt=0;
                    String trClass="info";
                    %>
		        ...
		        <tr>
		          <th rowspan=2>#</td>
		          <th rowspan=2>Plain/Print Type</td>
		          <th rowspan=2 nowrap=nowrap>Select Print/Plain</td>
...
<td><%= mast.getTypeCheckListOnChange() %></td>
