...
function validateFormFields()
{
 ...
 if(document.SOMaster.display.value != "display")
 {
   ...
   {
   reason+="Please Select Customer Name .\n";
   }else if(document.SOMaster.soDate.value=="")
   {
   reason+="Please Enter  SO Received Date.\n";
   }else if(document.SOMaster.soDelDate.value=="")
   {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String customer=request.getParameter("customer"); if(customer==null)customer="";
     String soNo=request.getParameter("soNo"); if(soNo==null)soNo="";
     ...
     int poNo=0;
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_so_master";
     ...
     String sqlInsert="INSERT INTO t_so_master(ID,SO_NO,SO_DATE,CUST_ID,SO_STATUS,EXP_DLV_DATE,REMARKS) VALUES "+
     " ("+maxId+",'"+soNo+"','"+soDate+"','"+customer+"','N','"+soDelDate+"', '"+remarks+"')"; 
     //out.println(sqlInsert);
     poNo= maxId+1000;
     int x=st.executeUpdate(sqlInsert);
     message= "New Sales Order has been created successfully. SO No."+poNo;
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Create SO</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SOMaster">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                              ...
                              <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">SO No</label>
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name="soNo" id="soNo" placeholder="SO No.">
                                    </div>
                            </div>
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">SO Received Date</label>
                                    <div class="col-sm-6">
                                            <input type="date"  name= "soDate" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                    </div>
                            </div>
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Exp. Delivery Date</label>
                                     <div class="col-sm-6">
                                            <input type="date"  name= "soDelDate" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
                                    </div>
                            </div>
