      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Print SO Report</h4>
                </div>
                <%
...
String mainSql=" SELECT DISTINCT s.ID ID, s.NAME STYLE_NAME,s.DESCR,C.NAME CUSTOMER_NAME, F_IMAGE_NAME,B_IMAGE_NAME, IMAGE_PATH,"+
 ...
 <div class="form-group">                        
    <div class="col-md-12 span_4">
      ...
      <table width=90%>
   <tr><td valign=top nowrap=nowrap align=center colspan=2><b> Sales Order Report <br><br> </b></th>
   </tr>
 <%
 while(rsMain.next()){
 style="0";
...
String bImageName ="",id="",stName="",fab="",descr="",fImage="",bImage ="",monthYear="";
  ...
  %>    
   ...
   <tr><td valign=top nowrap=nowrap><b> <h4>Combo Details in Style (SO)</h4><br> 
   <hr></hr>
...
<div class="form-group">                        
    ...
    <tr><td valign=top nowrap=nowrap><b> <h4>Qty. Details</h4><br> 
...
<table class="table"  border = "1" align="left" cellspacing = "1" cellpadding="1" style="border-collapse: collapse">
		        ...
		        <tr>
		          <th rowspan=2>Total <br> in All Styles</td>
