...
function validateFormFields()
{
 ...
 if(document.SOMaster.display.value != "display")
 {
   ...
   if(document.SOMaster.tailor.value=="0")
   {
   reason+="Please Select Tailor .\n";
   }else if(document.SOMaster.recDate.value=="")
   {
   reason+="Please Enter Receive Date .\n";
...
{   
 ...
 showDtl= "SELECT NAME FROM t_tailor_master where ID="+tailor+"";
 
  rs= st.executeQuery(showDtl);
       if(rs.next()){
       tailorName= rs.getString("NAME");     if(tailorName==null)tailorName="";
       } 

    
           
       showDtl =" SELECT DISTINCT s.ID STYLE_ID, s.NAME  "+
       ...
       style= rs.getString("STYLE_ID");     if(style==null)style="0";
       }
 ...
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String recDate= request.getParameter("recDate");if(recDate==null)recDate="";
     String expRecDate= request.getParameter("expRecDate");if(expRecDate==null)expRecDate="";
    ...
    int maxId=0;
     ...
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_tailor_receive";
     ...
     if(maxId==0)maxId=1;      
      ...
      String sqlInsert="INSERT INTO t_tailor_receive(ID,SO_DTL_ID,TLR_ID,ES_R,S_R,M_R,L_R,XL_R,XXL_R,XXXL_R,FREE_R,REC_DATE,REC_REMARKS)"+
      " VALUES "+
     " ("+maxId+","+soDtlId+","+mast.getTailor()+","+esTemp+","+sTemp+","+mTemp+","+lTemp+","+xlTemp+","+xxlTemp+","+xxxlTemp+","+freeTemp+",'"+recDate+"','"+remarks+"')"; 
     ...
     // check data availability in so_style_availability
      ...
      //out.println(chkSql);
       ...
       String sqlUpdateStock2="UPDATE t_so_style_tracking set TAILORING_ISSUED= '"+issueStatus+"' "+
     ...
     message= " Selected Item has been received from Tailoring Department successfully.";
                    ...
                    <form class="form-horizontal" name="SOMaster">
                      ...
                      <div class="form-group">
                         ...
                         <div class="form-group">
                            ...
                            <input type="HIDDEN" name="tailor" value="<%=tailor%>">
                           ...
                           <div class="form-group">
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label">Tailor</label>
                                    <div class="col-sm-6" align=left>
                                             <label for="selector1" class="col-sm-6 control-label"><%=tailorName%></label>
                                    </div>
...
<%                           
      String dtlSql="";
      //out.println("reached"+style);
if(!style.equalsIgnoreCase("0")){ 
String bImageName ="",id="",stName="",fab="",descr="",fImage="",bImage ="",monthYear="";

    String fullIssueStatus="N";
                String fullIssueSql="SELECT TAILORING_RECEIVED FROM t_so_style_tracking where SO_ID="+mast.getSo()+" "+
                " and STYLE_ID="+style+" ";
                
                rs= st.executeQuery(fullIssueSql);
                
                if(rs.next()){
                fullIssueStatus= rs.getString("TAILORING_RECEIVED"); 
                }
...
<div class="form-group">                        
                    ...
                    // out.println(sql3);
                         ...
                         rs2 = st2.executeQuery(sql3);
                          ...
                          <td rowspan=1 align=left><%=rs2.getString("PRINT_NAME")%><br>
                            <div class="col-sm-2"><img height="42" width="42" src="/pgmis/images/prints/<%=pImage%>" alt=""/></div>
                          </td>
                          </td>
                           <%}
           ...
           <%  
            ...
            <%
             ...
             " SUM(ifnull(t.ES_I,0))ES, SUM(ifnull(t.S_I,0))S,SUM(ifnull(t.M_I,0))M,SUM(ifnull(t.L_I,0))L,"+
              " SUM(ifnull(t.XL_I,0))XL,SUM(ifnull(t.XXL_I,0))XXL,SUM(ifnull(t.XXXL_I,0))XXXL,SUM(ifnull(t.FREE_I,0))FREE,"+
             ...
             //out.println(sql2);
               ...
               while(rs.next())
                      ...
                      %>
                       ...
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row">Qty. sent to selected Tailor</th>
                           <td align=center><%=es%></td>
                          <td align=center><%=s%></td>
                          <td align=center><%=m%></td>
                          <td align=center><%=l%></td>
             ...
             //out.println(sql2);
               ...
               while(rs.next())
                      ...
                      %>
                       ...
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><font color=red>Qty. sent to selected Tailor</th>
                           <td align=center><%=es%></td>
                          <td align=center><%=s%></td>
                          <td align=center><%=m%></td>
                          <td align=center><%=l%></td>
		    ...
		    <%
                 ...
                 // recieved from tailor    
                     ...
                     " REC_REMARKS REMARKS "+
                     " from t_so_details SOD, t_so_master SO, t_tailor_receive t "+
                     " WHERE SOD.SO_ID= SO.ID "+
                     " AND SOD.ID="+soDtlId+" "+
                     " AND t.SO_DTL_ID= SOD.ID"+
                      " AND t.TLR_ID="+mast.getTailor()+" "+
               ...
               while(rs.next())
                      ...
                      %>
                       ...
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><B><font color=red>Qty. received from selected Tailor</th>
                           <td align=center><%=es%></td>
                          <td align=center><%=s%></td>
                          <td align=center><%=m%></td>
                          <td align=center><%=l%></td>
		    ...
		    <%
               ...
               while(rs.next())
                      ...
                      %>
                       ...
                       <tr scope="row" class="<%=trClass%>">
		        <th scope="row"><B>Qty. received from all Tailor</th>
                           <td align=center><%=es%></td>
                          <td align=center><%=s%></td>
                          <td align=center><%=m%></td>
                          <td align=center><%=l%></td>
		    ...
		    <%
                     ...
                     // out.println(mast.getTypeCheck());
                      ...
                      %>   
  <tr>
    <td align="center"><b><font color="Red">Enter Qty. to be received from Tailor</b></td>
         <td>
  ...
  <td>
    ...
    <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Date of Receive</label>
                                    <div class="col-sm-4">
                                             <input type="date"  name= "recDate" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
      ...
      <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Check -if full tailoring is received for the selected style</label>
                                    <div class="col-sm-1">
    ...
    <div class="form-group">                        
      ...
      <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_5 btn-lg btn-warning warning_11" onclick="window.location.href='TailorReceive.jsp'">Back</button> 
                                 </p>
                            </div>
