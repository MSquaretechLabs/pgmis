...
function validateFormFields()
{
 ...
 if(document.SOMaster.display.value != "display")
 {
   ...
   }else if(document.SOMaster.issueDate.value=="")
   {
   reason+="Please Enter Issue Date .\n";
   }else if(document.SOMaster.expRecDate.value=="")
   {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String issueDate= request.getParameter("issueDate");if(issueDate==null)issueDate="";
    ...
    int maxId=0;
     ...
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_tailor_issue";
     ...
     if(maxId==0)maxId=1;      
      ...
      String sqlInsert="INSERT INTO t_tailor_issue"+
      " (ID,SO_DTL_ID,TLR_ID,ES_I,S_I,M_I,L_I,XL_I,XXL_I, XXXL_I,FREE_I, ISSUE_DATE,EXP_REC_DATE,ISSUE_REMARKS)"+
      " VALUES "+
     " ("+maxId+","+soDtlId+","+mast.getTailor()+","+esTemp+","+sTemp+","+mTemp+","+lTemp+","+xlTemp+","+xxlTemp+", "+xxxlTemp+","+freeTemp+", '"+issueDate+"','"+expRecDate+"','"+remarks+"')"; 
     ...
     message= " Selected Item has been issued to Tailoring Department successfully.";
...
<div class="form-group">                        
    ...
    <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label">Select Tailor Group</label>
                                    <div class="col-sm-4">
           ...
           <%  
		    ...
		    <%
                     ...
                     // out.println(mast.getTypeCheck());
                      ...
                      %>   
  <tr>
    <td align="center"><b><font color="Red">Enter Qty. to be sent to Tailor</b></td>
         <td>
  ...
  <td>
    ...
    <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Date of Issue</label>
                                    <div class="col-sm-4">
                                             <input type="date"  name= "issueDate" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
      ...
      <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Expected Delivery Date</label>
                                    <div class="col-sm-4">
                                             <input type="date"  name= "expRecDate" class="form-control1 ng-invalid ng-invalid-required" ng-model="model.date" required="">
      ...
      <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Check -if full tailoring is issued for the selected style</label>
                                    <div class="col-sm-1">
