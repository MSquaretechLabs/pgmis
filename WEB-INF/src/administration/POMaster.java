...
String dtr1="",ss1="",gesName="",manu="", dtr="",dtr2="",dtr3="",dtrNo="",sstnNo="",ymanu="",cdtr="",pon="0",tender="0",po="0",so="0",poDtl="0",dyer="0",printer="0",customer="0",customerUpdate="0",otherCustomer="0",di="0";
int id=0,kva=0;
String fab="",tailor="0",var="0",user="0",plain="0",product="0",style="0",fabUpdate="0",subProduct="0",typeCheck="Print",print="0",optMonth="",optYear="";
    @Deprecated
...
String adminId="",fetchPressed="",kvaName="",manuName="",startDate="",endDate="",transferDate="";
  ...
  String message="",varUpdate="0",productUpdate="0";
 ...
 public String getName(){return name;}
    ...
    public void setFabUpdate(String fabUpdate)  
       {  
         if(fabUpdate != null) this.fabUpdate = fabUpdate;  else this.fabUpdate = "0";
       }
    public String getFabUpdate(){return fabUpdate;}
    
    public void setVarUpdate(String varUpdate)  
       {  
         if(varUpdate != null) this.varUpdate = varUpdate;  else this.varUpdate = "0";
       }
    public String getVarUpdate(){return varUpdate;}
    ...
    public void setProductUpdate(String productUpdate)  
       {  
         if(productUpdate != null) this.productUpdate = productUpdate;  else this.productUpdate = "0";
       }
    ...
    public void setCustomerUpdate(String customerUpdate)  
       {  
         if(customerUpdate != null) this.customerUpdate = customerUpdate;  else this.customerUpdate = "0";
       }
    ...
    public void setPrinter(String printer)  
       {  
         if(printer != null) this.printer = printer;  else this.printer = "0";
       }
   ...
   public String getFetchPressed(){return fetchPressed;}
    ...
    public void setUser(String user)
       {  
         if(user != null) this.user = user;  else  this.user = "0";
       }
 ...
 public String getCompName(){return compName;}
    ...
    public String getUserListOnChange() throws SQLException
     {
      String sql = "SELECT ID, LOGIN_ID NAME FROM t_user ORDER BY ID";
      LTStudList = BaseBean.get().getSelectHtmlOnChange("user",sql,"showData()",getUser());
      return LTStudList;
     }
    ...
    public String getVPOSupllierMasterList() throws SQLException
     {
      String sql = "SELECT P.ID ID, concat(PO_NO,'-',S.NAME,'-dated.',DATE_FORMAT(PO_DATE,'%d-%b-%Y')) NAME FROM t_po_master P, t_supplier_master S where P.SUP_ID= S.ID and PO_STATUS='Y' ORDER BY ID";
      LTStudList = BaseBean.get().getSelectHtmlOnChange("po",sql,"showData()",getPo());
      return LTStudList;
     }
    ...
    public String getDyerListOnChange() throws SQLException
     {
      String sql = "SELECT ID, NAME FROM t_dyer_master ORDER BY NAME";
      LTStudList = BaseBean.get().getSelectHtmlOnChange("dyer",sql,"showData()",getDyer());
      return LTStudList;
     }
    public String getPODyerListOnChange() throws SQLException
     {
         if(po != "0")
         {
         String sql = "SELECT  ID,  NAME FROM t_dyer_master "+
                      " WHERE ID IN (SELECT DP_ID FROM t_po_dp_details where PO_DTL_ID IN (SELECT ID FROm t_po_details where PO_ID="+po+") AND TYPE_CHECK='Plain')";   
         DivisionList = BaseBean.get().getSelectHtmlOnChange("dyer",sql,"showData()",getDyer());
         return DivisionList;
         }
         else{
             DivisionList = BaseBean.get().emptyListBox("dyer");
             return DivisionList;
         }
     }
    public String getPOPrinterListOnChange() throws SQLException
     {
         if(po != "0")
         {
         String sql = "SELECT  ID,  NAME FROM t_printer_master "+
                      " WHERE ID IN (SELECT DP_ID FROM t_po_dp_details where PO_DTL_ID IN (SELECT ID FROm t_po_details where PO_ID="+po+") AND TYPE_CHECK='Print')";   
         DivisionList = BaseBean.get().getSelectHtmlOnChange("printer",sql,"showData()",getPrinter());
         return DivisionList;
         }
         else{
             DivisionList = BaseBean.get().emptyListBox("printer");
             return DivisionList;
         }
     }
    public String getPrinterList() throws SQLException
     {
      String sql = "SELECT ID, NAME FROM t_printer_master ORDER BY NAME";
      LTStudList = BaseBean.get().getSelectHtml("printer",sql,getPrinter());
      return LTStudList;
     }
    public String getPrinterListOnChange() throws SQLException
     {
      String sql = "SELECT ID, NAME FROM t_printer_master ORDER BY NAME";
      LTStudList = BaseBean.get().getSelectHtmlOnChange("printer",sql,"showData()",getPrinter());
      return LTStudList;
     }
    ...
    public String getTailorListOnChange() throws SQLException
     {
      String sql = "SELECT ID,  NAME FROM t_tailor_master ORDER BY ID";
    ...
    public String getFabricListUpdate() throws SQLException
     {
      String sql = "SELECT ID,  NAME FROM t_fabric_master ORDER BY ID";
      LTStudList = BaseBean.get().getSelectHtml("fabUpdate",sql,getFabUpdate());
      return LTStudList;
     }
    public String getVarListUpdate() throws SQLException
     {
      String sql = "SELECT v.ID,  concat(f.NAME,' - ',v.name)   NAME FROM t_fabric_master f, t_var_master v where v.FABRIC_ID=f.ID ORDER BY f.ID,v.ID";
      LTStudList = BaseBean.get().getSelectHtml("varUpdate",sql,getVarUpdate());
      return LTStudList;
     }
    ...
    public String getProductCategoryListUpdate() throws SQLException
     {
      String sql = "SELECT ID,  NAME FROM t_product_master ORDER BY ID";
      LTStudList = BaseBean.get().getSelectHtml("productUpdate",sql,getProductUpdate());
      return LTStudList;
     }
    ...
    public String getCustomerListUpdate() throws SQLException
     {
      String sql = "SELECT ID,  NAME FROM t_customer_master ORDER BY ID";
      LTStudList = BaseBean.get().getSelectHtml("customerUpdate",sql,getCustomerUpdate());
      return LTStudList;
     }
    ...
    public String getStyleListOnChange() throws SQLException
     {
         ...
         return LTStudList;
            ...
            String sql = "SELECT  ID,  NAME FROM t_style_master WHERE CUST_ID=0";
            LTStudList = BaseBean.get().getSelectHtmlOnChange("style",sql,"showData()",getStyle());
            return LTStudList;
         }
    ...
    public String getSupplierListOnChange() throws SQLException
     {
       String sql = "SELECT ID, NAME FROM t_supplier_master ORDER BY NAME";
       ManufacturerList = BaseBean.get().getSelectHtmlOnChange("manu",sql,"showData()",getManu());
       return ManufacturerList;
     } 
    public String getPrintMaterList() throws SQLException
     {
       String sql = "SELECT ID, NAME FROM t_print_master ORDER BY NAME";
       ManufacturerList = BaseBean.get().getSelectHtml("print",sql,getPrint());
       return ManufacturerList;
     } 
    ...
    public String getPlainCodeListOnChange(String vId) throws SQLException
     {
         if(vId != "0")
         {
         String sql = "SELECT  ID,NAME FROM t_plain_master where VAR_ID="+vId+" order by NAME asc";
         DivisionList = BaseBean.get().getSelectHtmlOnChange("plain",sql,"showData()", getPlain());
         return DivisionList;
         }
         else{
             DivisionList = BaseBean.get().emptyListBox("plain");
    ...
    public String getPrintListOnChange() throws SQLException
     {
         ...
         String sql = "SELECT  ID,NAME FROM t_print_master  order by ID asc";
    ...
    public String getPrintList() throws SQLException
     {
         ...
         if(!customer.equalsIgnoreCase("0")&&(typeCheck.equalsIgnoreCase("Print")||typeCheck.equalsIgnoreCase("")))
         {
         String sql = "SELECT  ID,NAME FROM t_print_master where CUST_ID="+customer+" order by NAME asc";
         DivisionList = BaseBean.get().getSelectHtml("print",sql,getPrint());
         return DivisionList;
         }else if(typeCheck.equalsIgnoreCase("Plain"))
         {
         String sql = "SELECT  ID,NAME FROM t_plain_master order by NAME asc";
         DivisionList = BaseBean.get().getSelectHtml("print",sql,getPrint());
         return DivisionList;
         }
         else{
