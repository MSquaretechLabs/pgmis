...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   if(document.customer.acc.value=="0")
   {
   reason+="Please Select  Accessory Name .\n";
   }
   if(document.customer.accType.value=="0")
   {
   reason+="Please Select  Acc. Type .\n";
   }
    if(document.customer.accSubType.value=="0")
   {
   reason+="Please Select  Acc. Sub-type .\n";
   }
...
try{
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_acc_sub_type_master SET NAME='"+name+"'"+
     " WHERE ID="+mast.getAccSubType()+" AND TYPE_ID= "+mast.getAccType()+"";
  
     
     int x=st.executeUpdate(sqlUpdate);
     message= "Selected Item Sub Type has been updated successfully.";
  ...
  if(display.equalsIgnoreCase("delete"))
 {
     ...
     String sqlUpdate="DELETE FROM t_acc_sub_type_master WHERE ID= "+mast.getAccSubType()+" AND TYPE_ID= "+mast.getAccType()+"";
  
     
     int x=st.executeUpdate(sqlUpdate);
     message= "Selected Item  has been deleted successfully.";
  
  }
 }catch(Exception rt)
  {
   message= "Selected Item is not deleted successfully."+rt.getMessage();
  }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Accessory Sub-type </h4>
                </div>
               <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    ...
                    <form class="form-horizontal" name="customer">
                            <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Select Accessory</label>
                                    <div class="col-sm-4">
                                     <input type="HIDDEN" name="display" value=""></input>
                                            <%=mast.getAccListOnChange()%>
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Select Accessory Type</label>
                                    <div class="col-sm-4">
                                    
                                            <%=mast.getAccTypeListOnChange()%>
                                    </div>
                                    <div class="col-sm-2">
                                            <!--<p class="help-block">Please type new POMaster name!</p>-->
                                    </div>
                             ...
                             <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Select Accessory Sub-type</label>
                                    <div class="col-sm-4">
                                    
                                            <%=mast.getAccSubTypeListOnChange()%>
                                    </div>
                                    <div class="col-sm-2">
                                            <!--<p class="help-block">Please type new POMaster name!</p>-->
                                    </div>
      ...
      <%
      String nameTemp="",accTemp="0",codeTemp="";
      //out.println("reached herer"+mast.getFab());
      if(!mast.getAccType().equalsIgnoreCase("0")&& !mast.getAccType().equalsIgnoreCase(""))
      
      {
         
         String sqlDisplay="SELECT NAME, TYPE_ID  FROM t_acc_sub_type_master "+
         " where ID="+mast.getAccSubType()+" AND TYPE_ID="+mast.getAccType()+"";
      ...
      <div class="alert alert-info">
                        ...
                        <hr>
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Accessory Sub Type</label>
                                    <div class="col-sm-4">
