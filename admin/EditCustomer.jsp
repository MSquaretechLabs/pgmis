...
function deleteClick(){
    ...
    if(document.customer.customer.value!="0")
    {
...
if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_customer_master"+
     " SET NAME='"+name+"', ADDRESS='"+address+"', COUNTRY='"+country+"',PHONE='"+phone+"',"+
     " EMAIL='"+email+"', WEBSITE='"+website+"', CP='"+cp+"'"+
     " WHERE ID="+mast.getCustomer()+"";
  ...
  {
   message= "Customer is not updated successfully."+rt.getMessage();
  }
 ...
 {
     try{
     String sqlUpdate="DELETE FROM t_customer_master WHERE ID= "+mast.getCustomer()+"";
     int x=st.executeUpdate(sqlUpdate);
  ...
  {
   message=" Customer is not deleted successfully."+rt.getMessage();
  }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      if(!mast.getCustomer().equalsIgnoreCase("0")&& !mast.getCustomer().equalsIgnoreCase(""))
      
      {
         
         String sqlDisplay="SELECT ID,CP,NAME,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE FROM t_customer_master where ID="+mast.getCustomer()+"";
