         ...
         display=mrequest.getParameter("display"); if(display==null)display="";
           ...
           if(display.equalsIgnoreCase("save"))
           {
             ...
             String todo = null;
              ...
              String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_plain_master";
		...
		if ((files != null) && (!files.isEmpty()) )
		{
		   ...
		   if (uploadFileTemp1 != null){
                   //out.println("reacdh inside"+uploadFileTemp1);
                        uploadFileTemp1 = maxId+"_plain_"+uploadFileTemp1;
		        ...
		        upBean.store(mrequest, "fImage");
                  ...
                  String sqlInsert="INSERT INTO t_plain_master(ID,NAME,VAR_ID,CODE, IMAGE, IMAGE_PATH) VALUES "+
                     " ("+maxId+",'"+name+"','"+var+"','"+code+"','"+fImage+"', '"+imagePath+"')"; 
                    // out.println(sqlInsert);
                     //poNo= maxId+1000;
                     int x=st.executeUpdate(sqlInsert);
                     message= "New Plain Code has been created successfully.";
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Plain Code</h4>
                </div>
                <%
