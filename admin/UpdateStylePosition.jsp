...
{   
 ...
 String sdId= request.getParameter("sdId");// t_style_details id
 String style=request.getParameter("style"); if(style==null)style="0";
 String product=request.getParameter("product"); if(product==null)product="0";
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
    ...
    String printPos=request.getParameter("printPos"); if(printPos==null)printPos="";
     ...
     String sqlInsert="UPDATE t_style_details "+
     " SET PRINT_POSITION='"+printPos+"', "+
     " ES="+esTemp+", "+
     " S="+sTemp+", "+
     " M="+mTemp+", "+
     " L="+lTemp+", "+
     ...
     " FREE="+freeTemp+", "+
     " REMARKS='"+remarks+"' "+
     " WHERE ID="+sdId+" AND STYLE_ID="+style+"";
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Style Position Details</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="POMaster">
                      ...
                      <input type="HIDDEN" name="subProduct" value="<%=subProduct%>"></input>  
 <%                  
    ...
    <div class="col-md-12 span_3">
		  <div class="bs-example1" data-example-id="contextual-table">
           ...
           String  sql =" SELECT SD.ID, SD.PRINT_POSITION, "+
             ...
             " AND SD.STYLE_ID="+style+" AND SD.ID="+sdId+"";
...
<td align=left><font color=red>New</font></td>
   <td>
  <input type="text" size=10 class="form-control1" name="printPos" id="printPos" value="<%=printPos%>"  placeholder=" Print Position">
   </td>
    <td>
 ...
 <input type="text" class="form-control1" name="remarks" id="remarks" value="<%=remarks%>"  placeholder="Remarks">
                            ...
                            <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_5 btn-lg btn-warning success_11" onclick="javascript:window.location.href='AddStylePosition.jsp?product=<%=product%>&subProduct=<%=subProduct%>&customer=<%=customer%>&style=<%=style%>'" >Back</button> 
                                 </p>
                            </div>
