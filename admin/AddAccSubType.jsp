...
function validateFormFields()
{
 ...
 if(document.POMaster.display.value != "display")
 {
   ...
   if(document.POMaster.accType.value=="0")
   {
   reason+="Please Select Accessory Type.\n";
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String accType=request.getParameter("accType"); if(accType==null)accType="";
     String name=request.getParameter("name"); if(name==null)name="";
   
  
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_acc_sub_type_master";
     ...
     String sqlInsert="INSERT INTO t_acc_sub_type_master(ID,NAME,TYPE_ID) VALUES "+
     " ("+maxId+",'"+name+"','"+accType+"')"; 
     //out.println(sqlInsert);
     //poNo= maxId+1000;
    int x=st.executeUpdate(sqlInsert);
     message= "New Sub Type has been created successfully.";
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Accessory Sub Type</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="POMaster">
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label">Select Accessory Type</label>
                                    <div class="col-sm-4">
                             ...
                             <div class="form-group">
                            <label for="focusedinput" class="col-sm-4 control-label">Name of Sub Type</label>
                                    <div class="col-sm-4">
