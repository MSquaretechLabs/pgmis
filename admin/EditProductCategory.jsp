...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   {
   reason+="Please Enter  Product  Category .\n";
   }
   if (reason != "") {
...
try{
 ...
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_product_master SET NAME='"+name+"' WHERE ID= "+mast.getProduct()+"";
  
    // out.println(sqlUpdate);
     int x=st.executeUpdate(sqlUpdate);
     message= "Selected Product Category has been updated successfully.";
   ...
   if(display.equalsIgnoreCase("delete"))
 {
     ...
     String sqlUpdate="DELETE FROM t_product_master WHERE ID= "+mast.getProduct()+"";
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Product Category</h4>
                </div>
               <%
      ...
      if(!mast.getProduct().equalsIgnoreCase("0")&& !mast.getProduct().equalsIgnoreCase(""))
      
      {
         
         String sqlDisplay="SELECT NAME FROM t_product_master where ID="+mast.getProduct()+"";
       ...
       <div class="alert alert-info">
                        ...
                        <hr>
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Product Category</label>
                                    <div class="col-sm-4">
