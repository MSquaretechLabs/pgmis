...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_dyer_master";
     ...
     String sqlInsert="INSERT INTO t_dyer_master(ID,NAME,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE,MOBILE,CP) VALUES "+
     " ("+maxId+",'"+name+"','"+address+"','"+country+"','"+phone+"','"+email+"','"+website+"','"+mobile+"','"+cp+"')"; 
     //out.println(sqlInsert);
     
     int x=st.executeUpdate(sqlInsert);
     message= "New Dyer has been added successfully.";
  
  }catch(Exception rt)
  {
   message= "New Dyer is not added successfully."+rt.getMessage();
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Dyer</h4>
                </div>
               <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    ...
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Dyer Name">
                                    </div>
                                    <div class="col-sm-2">
