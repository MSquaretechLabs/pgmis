     ...
     <!-- Navigation -->
        ...
        <div class="col_1">
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
                   ...
                   <h4 class="panel-title">Supplier  Report</h4><br>
               
                    <%
                    
                    String sql= "SELECT NAME,CP,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE,MOBILE "+
                    " FROM t_supplier_master";
                   // out.println(sql);
                    int count=1;
                    rs= st.executeQuery(sql);
                    String name="",address="",country="",phone,email,website="",mobile="",cp="";
		      ...
		      <tbody>
                      <%
                       ...
                       cp= rs.getString("CP");if(cp==null)cp="";
                       ...
                       website= rs.getString("WEBSITE");if(website==null)website="";
                       mobile= rs.getString("MOBILE");if(mobile==null)mobile="";
