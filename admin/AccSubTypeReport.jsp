...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="panel-heading">
                    <h4 class="panel-title">Accessory Sub Type Report</h4>
                </div>
     <div class="col_1">
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
                    ...
                    String sql= "SELECT P.NAME P_NAME, PS.NAME PS_NAME , ST.NAME ST_NAME "+
                    " FROM t_acc_master P, t_acc_type_master PS, t_acc_sub_type_master ST"+
                    " WHERE PS.ACC_ID= P.ID AND ST.TYPE_ID= PS.ID ORDER BY ACC_ID";
                   // out.println(sql);
                    int count=1;
                    rs= st.executeQuery(sql);
                    String type="",name="",fabName="",code="",phone,email,website="";
		      ...
		      <tbody>
                      <%
                       ...
                       ++cnt;
                       name= rs.getString("ST_NAME");if(name==null)name="";
                       fabName= rs.getString("P_NAME");if(fabName==null)fabName="";
                       type= rs.getString("PS_NAME");if(type==null)type="";
