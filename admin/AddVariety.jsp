...
function validateFormFields()
{
 ...
 if(document.POMaster.display.value != "display")
 {
   ...
   if(document.POMaster.fab.value=="0")
   {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlInsert="INSERT INTO t_var_master(ID,NAME,FABRIC_ID,CODE) VALUES "+
     " ("+maxId+",'"+name+"','"+fab+"','"+code+"')"; 
     //out.println(sqlInsert);
     //poNo= maxId+1000;
     int x=st.executeUpdate(sqlInsert);
     message= "New Variety has been created successfully.";
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Variety</h4>
                </div>
                <%
