...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   {
   reason+="Please Enter  Product Category  Name .\n";
   }
   if (reason != "") {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
    ...
    // String website=request.getParameter("website"); if(website==null)website="";
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_product_master";
     ...
     String sqlInsert="INSERT INTO t_product_master(ID,NAME) VALUES "+
     " ("+maxId+",'"+name+"')"; 
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Product Cagegory</h4>
                </div>
               <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    ...
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Product Category">
                                    </div>
                                    <div class="col-sm-2">
