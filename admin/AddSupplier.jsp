...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   {
   reason+="Please Enter  Supplier  Name .\n";
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_supplier_master";
    // out.println(maxIdSql);
     ...
     String sqlInsert="INSERT INTO t_supplier_master(ID,NAME,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE,MOBILE,CP) VALUES "+
     " ("+maxId+",'"+name+"','"+address+"','"+country+"','"+phone+"','"+email+"','"+website+"','"+mobile+"','"+cp+"')"; 
    // out.println(sqlInsert);
     
     int x=st.executeUpdate(sqlInsert);
     message= "New Supplier has been added successfully.";
  
  }catch(Exception rt)
  {
   message= "New Supplier is not added successfully."+rt.getMessage();
  }
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Supplier</label>
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Supplier Name">
                                    </div>
                                    <div class="col-sm-2">
