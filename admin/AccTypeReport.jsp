...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="panel-heading">
                    <h4 class="panel-title">Accessory Type Report</h4>
                </div>
     <div class="col_1">
		  ...
		  <div class="bs-example1" data-example-id="contextual-table">
                    ...
                    String sql= "SELECT P.NAME P_NAME, PS.NAME PS_NAME "+
                    " FROM t_acc_master P, t_acc_type_master PS WHERE PS.ACC_ID= P.ID ORDER BY ACC_ID";
                   // out.println(sql);
                    int count=1;
