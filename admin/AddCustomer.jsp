...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   {
   reason+="Please Enter  Customer  Name .\n";
   }else if(document.customer.address.value=="")
   {
   reason+="Please Enter  Address.\n";
   }else if(document.customer.country.value=="")
   {
   reason+="Please Enter  Name of Country.\n";
   }else if(document.customer.phone.value=="")
   {
   reason+="Please Enter  Phone.\n";
   }
   if (reason != "") {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_customer_master";
     ...
     String sqlInsert="INSERT INTO t_customer_master(ID,NAME,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE,CP) VALUES "+
     " ("+maxId+",'"+name+"','"+address+"','"+country+"','"+phone+"','"+email+"','"+website+"','"+cp+"')"; 
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Customer</label>
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Customer Name">
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Country</label>
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name="country" id="country" placeholder="Name of Country">
                                    </div>
                            </div>
