...
// out.println(display);
  if(display.equalsIgnoreCase("save"))
 {
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_printer_master";
    // out.println(maxIdSql);
     ...
     String sqlInsert="INSERT INTO t_printer_master(ID,NAME,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE,MOBILE,CP) VALUES "+
     " ("+maxId+",'"+name+"','"+address+"','"+country+"','"+phone+"','"+email+"','"+website+"','"+mobile+"','"+cp+"')"; 
    // out.println(sqlInsert);
     
     int x=st.executeUpdate(sqlInsert);
     message= "New Printing Agency has been added successfully.";
  
  }catch(Exception rt)
  {
   message= "New Printing Agency is not added successfully."+rt.getMessage();
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Printer</h4>
                </div>
               <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Printing Agency</label>
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Printer Name">
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Contact Person</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name="cp" id="cp" placeholder="Contact Person">
                                    </div>
                            </div>
                             <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">Address</label>
                                    <div class="col-sm-8">
                                            <input type="text" class="form-control1" name="address" id="address" placeholder="Full Address">
                                    </div>
                            </div>
                              <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">Place</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name="country" id="country" placeholder="Name of Place">
                                    </div>
                            </div>
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Contact No.(Landline)</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name="phone" id="phone" placeholder="Phone No.">
                                    </div>
                            </div>
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Contact No.(Mobile)</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name="mobile" id="mobile" placeholder="Mobile No.">
                                    </div>
                            </div>
                          ...
                          <div class="form-group">
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Website</label>
                                    <div class="col-sm-6">
                                            <input type="text" class="form-control1" name="website" id="website" placeholder="Website Address">
                                    </div>
                            </div>
