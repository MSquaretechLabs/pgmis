...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   {
   reason+="Please Enter  Fabric  Name .\n";
   }
   if (reason != "") {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
    ...
    // String website=request.getParameter("website"); if(website==null)website="";
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_fabric_master";
    // out.println(maxIdSql);
     ...
     String sqlInsert="INSERT INTO t_fabric_master(ID,NAME) VALUES "+
     " ("+maxId+",'"+name+"')"; 
     //out.println(sqlInsert);
     
     int x=st.executeUpdate(sqlInsert);
     message= "New Fabric Item has been added successfully.";
