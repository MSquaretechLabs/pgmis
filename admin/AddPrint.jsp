...
String path="C:/Tomcat 6.0/webapps/pgmis/images/prints   /usr/local/tomcat/webapps/www.nidhiashok.in/pgmis/docs/styles";
       ...
       MultipartFormDataRequest mrequest = new MultipartFormDataRequest(request);
        ...
        display=mrequest.getParameter("display"); if(display==null)display="";
         ...
         String type="1";
             ...
             if(!customer.equalsIgnoreCase("0"))type="2";else type="1";
           
           
           if(display.equalsIgnoreCase("save"))
           {
            //out.println(" in save"+display);
             String fImage="",imagePath="/pgmis/images/prints/";
             String todo = null;
             
             String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_print_master";
		...
		if ((files != null) && (!files.isEmpty()) )
		{
		   ...
		   if (uploadFileTemp1 != null){
                   //out.println("reacdh inside"+uploadFileTemp1);
                        uploadFileTemp1 = maxId+"_print_"+uploadFileTemp1;
		        ...
		        upBean.store(mrequest, "fImage");
                  ...
                  //out.println("bImage-"+bImage);
                      ...
                      String sqlInsert="INSERT INTO t_print_master(ID,NAME,TYPE,CUST_ID,IMAGE, IMAGE_PATH) VALUES "+
                     " ("+maxId+",'"+name+"','"+type+"','"+customer+"','"+fImage+"', '"+imagePath+"')"; 
                    // out.println(sqlInsert);
                     //poNo= maxId+1000;
                     int x=st.executeUpdate(sqlInsert);
                     message= "New Print Code has been added successfully.";
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Print</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" method=post name="POMaster" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
									...
									<div class="col-sm-8">
										<div class="radio block"><label><input type="radio" name="type"> Self</label></div>
