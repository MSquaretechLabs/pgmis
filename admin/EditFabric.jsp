...
try{
 ...
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_fabric_master SET NAME='"+name+"' WHERE ID= "+mast.getFab()+"";
  
     
     int x=st.executeUpdate(sqlUpdate);
     message= "Selected Fabric Item has been updated successfully.";
 ...
 if(display.equalsIgnoreCase("delete"))
 {
     ...
     String sqlUpdate="DELETE FROM t_fabric_master WHERE ID= "+mast.getFab()+"";
  
     
     int x=st.executeUpdate(sqlUpdate);
     message= "Selected Fabric Item has been deleteted successfully.";
  
  }
  
 }catch(Exception rt)
  {
   message= "Fabric is not deleted successfully."+rt.getMessage();
  }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Fabric Name</h4>
                </div>
               <%
      ...
      
      {
         ...
         String sqlDisplay="SELECT NAME FROM t_fabric_master where ID="+mast.getFab()+"";
       ...
       <div class="alert alert-info">
                        ...
                        <hr>
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Fabric</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name= "name" id="name" value="<%=nameTemp%>" placeholder="Fabric Name">
                                    </div>
                                    <div class="col-sm-2">
