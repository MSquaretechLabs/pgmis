...
function deleteClick(){
    ...
    if(document.customer.manu.value!="0")
    {
...
if(display.equalsIgnoreCase("save"))
 {
  ...
  {
   message=" Supplier is not updated successfully."+rt.getMessage();
  }
...
if(display.equalsIgnoreCase("delete"))
 {
     try{
     String sqlUpdate="DELETE FROM t_supplier_master WHERE ID= "+mast.getManu()+"";
     int x=st.executeUpdate(sqlUpdate);
     message= "Selected Supplier  has been deleted successfully.";
     
  
  }catch(Exception rt)
  {
   message=" Supplier is not deleted successfully."+rt.getMessage();
  }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Supplier Details</h4>
                </div>
               <%
      ...
      
      {
         ...
         String sqlDisplay="SELECT ID,NAME,ADDRESS,COUNTRY,PHONE, CP,EMAIL,WEBSITE,MOBILE FROM t_supplier_master where ID="+mast.getManu()+"";
       ...
       <div class="alert alert-info">
                        ...
                        <hr>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name= "name" id="name" value="<%=nameTemp%>" placeholder="Supplier Name">
                                    </div>
                                    <div class="col-sm-2">
