...
function validateFormFields()
{
 ...
 if(document.POMaster.display.value != "display")
 {
   ...
   if(document.POMaster.product.value=="0")
   {
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String product=request.getParameter("product"); if(product==null)product="";
     String name=request.getParameter("name"); if(name==null)name="";
     String code=request.getParameter("code"); if(code==null)code="";
  
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_product_sub_master";
     ...
     String sqlInsert="INSERT INTO t_product_sub_master(ID,NAME,PRODUCT_ID,CODE) VALUES "+
     " ("+maxId+",'"+name+"','"+product+"','"+code+"')"; 
     //out.println(sqlInsert);
     //poNo= maxId+1000;
     int x=st.executeUpdate(sqlInsert);
     message= "New Product Sub-category has been created successfully.";
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Product Sub Category</h4>
                </div>
                <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="POMaster">
                            ...
                            <label for="focusedinput" class="col-sm-4 control-label">Name of Product Sub Category</label>
                                    <div class="col-sm-4">
                            ...
                            <label for="focusedinput" class="col-sm-4 control-label">Code</label>
                                    <div class="col-sm-2">
                                            <input type="text" class="form-control1" name="code" id="code" placeholder="Code">
                                    </div>
                            </div>
