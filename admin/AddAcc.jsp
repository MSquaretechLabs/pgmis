...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
    ...
    // String website=request.getParameter("website"); if(website==null)website="";
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_acc_master";
     ...
     String sqlInsert="INSERT INTO t_acc_master(ID,NAME) VALUES "+
     " ("+maxId+",'"+name+"')"; 
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add New Accessory</h4>
                </div>
               <%
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Accessory</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Accessory">
                                    </div>
                                    <div class="col-sm-2">
