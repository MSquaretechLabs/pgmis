...
if(dispVal=="")
{
    ...
    if (password!=pass1)
        ...
        window.location="/pgmis/admin/VerifyPO.jsp";
        }
...
function validateForm(){
 ...
 {  if(document.POMaster.display.value != "display"){
   var check = confirm("Do you want to Approve and Verify?")
   if(check){
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String verify=request.getParameter("verify"); if(verify==null)verify="";
     if(verify.equalsIgnoreCase(""))verify="N";
     
     if(verify.equalsIgnoreCase("on"))verify="Y";
   
      String sqlInsert="UPDATE t_po_master SET PO_STATUS='"+verify+"' WHERE ID="+mast.getPo()+"";
     // out.println(sqlInsert);
     int x=st.executeUpdate(sqlInsert);
     message= " PO has been verified/updated successfully.";
  }
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Verify PO</h4>
                </div>
                <%
...
if(!mast.getPo().equalsIgnoreCase("0")){ 
  ...
  dtlSql = "SELECT A.ID,  A.PO_NO PO_NO , A.SUP_ID ,DATE_FORMAT(PO_DATE,'%d-%b-%Y') PO_DATE ,CREATED_BY,BOOK_NO"+ 
    ...
    status= rs.getString("PO_STATUS"); if(status==null)status="N";
    if(status.equalsIgnoreCase("N"))checked="";
    }
...
<div class="form-group">                        
    <div class="col-md-12 span_4">
     ...
     <div>
     <input type="checkbox" <%=checked%> name="verify" >&nbsp;&nbsp;<b> Verify and Approve</b>
     </div>
		   </div>
                            ...
                            <div class="but_list" align=center>
                                 ...
                                 <p>        
                                 <button type="button" class="btn btn_5 btn-lg btn-warning warning_11" onclick="javascript:submitClick()" >Verify</button> 
