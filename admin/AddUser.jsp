...
if(dispVal=="")
{
    ...
    if (password!=pass1)
        ...
        window.location="/pgmis/admin/AddUser.jsp";
        }
...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     int maxId=0;
     String maxIdSql="SELECT MAX(ID)+1 MAX_ID FROM t_user";
     ...
     String sqlInsert="INSERT INTO t_user(ID,LOGIN_ID,PASSWORD, FULL_NAME, MODULE_ID) VALUES "+
     " ("+maxId+",'"+name+"','"+password+"','"+fullName+"',"+module+")"; 
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="customer">
                            ...
                            <input type="HIDDEN" name="display" value=""></input>
                                    ...
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name= "name" id="name" placeholder="Login ID">
                                    </div>
                                    <div class="col-sm-2">
                            ...
                            <label for="focusedinput" class="col-sm-2 control-label">Full Name</label>
                                    <div class="col-sm-4">
                                            <input type="text" class="form-control1" name="fullName" id="fullName" placeholder="Full Name">
                                    </div>
                            </div>
