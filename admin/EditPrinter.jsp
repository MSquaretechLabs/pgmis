...
function validateFormFields()
{
 ...
 if(document.customer.display.value != "display")
 {
   ...
   {
   reason+="Please Enter  Printer  Name .\n";
...
function deleteClick(){
    ...
    if(document.customer.printer.value!="0")
    {
...
if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_printer_master "+
     " SET NAME='"+name+"', ADDRESS='"+address+"', COUNTRY='"+country+"',PHONE='"+phone+"',"+
     " EMAIL='"+email+"', WEBSITE='"+website+"', MOBILE='"+mobile+"', CP='"+cp+"' "+
     " WHERE ID="+mast.getPrinter()+"";

     int x=st.executeUpdate(sqlUpdate);
     message= "Printer has been updated successfully.";
  
  }catch(Exception rt)
  {
   message= "Printer is not updated successfully."+rt.getMessage();
  }
 ...
 if(display.equalsIgnoreCase("delete"))
 {
     try{
            ...
            boolean deleteAllow=true;
             ...
             String sqlCheck="SELECT ID FROM t_po_dp_details WHERE TYPE_CHECK='Print' AND DP_ID="+mast.getPrinter()+" "+
             " AND QTY_SENT>0";
            // out.println(sqlCheck);
             ...
             {
             deleteAllow= false;
             message+= "Data for selected Printer is Available in PO Details.Printer can not be deleted. ";
             }
            ...
            //deleteAllow= true;
             ...
             String sqlUpdate="DELETE FROM t_printer_master WHERE ID= "+mast.getPrinter()+"";
             int x=st.executeUpdate(sqlUpdate);
             message= "Selected Printer  has been deleted successfully.";
             
             }
  
  }catch(Exception rt)
  {
   message=" Printer is not deleted successfully."+rt.getMessage();
  }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Printer Details</h4>
                </div>
               <%
      ...
      if(!mast.getPrinter().equalsIgnoreCase("0")&& !mast.getPrinter().equalsIgnoreCase(""))
      
      {
         
         String sqlDisplay="SELECT ID,CP,NAME,ADDRESS,COUNTRY,PHONE, EMAIL,WEBSITE,MOBILE FROM t_printer_master where ID="+mast.getPrinter()+"";
       ...
       <div class="alert alert-info">
                        ...
                        <hr>
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Printer</label>
                                    <div class="col-sm-4">
