...
try{
 ...
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_acc_master SET NAME='"+name+"' WHERE ID= "+mast.getAcc()+"";
   ...
   if(display.equalsIgnoreCase("delete"))
 {
     ...
     String sqlUpdate="DELETE FROM t_acc_master WHERE ID= "+mast.getAcc()+"";
  ...
  {
   message= "Accessory is not deleted successfully."+rt.getMessage();
  }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Accessory Item</h4>
                </div>
               <%
      ...
      if(!mast.getAcc().equalsIgnoreCase("0")&& !mast.getAcc().equalsIgnoreCase(""))
      
      {
         
         String sqlDisplay="SELECT NAME FROM t_acc_master where ID="+mast.getAcc()+"";
