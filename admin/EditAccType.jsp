...
try{
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_acc_type_master SET NAME='"+name+"'"+
     " WHERE ID="+mast.getAccType()+" AND ACC_ID= "+mast.getAcc()+"";
  ...
  if(display.equalsIgnoreCase("delete"))
 {
     ...
     String sqlUpdate="DELETE FROM t_acc_type_master WHERE ID= "+mast.getAccType()+" AND ACC_ID= "+mast.getAcc()+"";
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Update Accessory Type </h4>
                </div>
               <%
      ...
      
      {
         ...
         String sqlDisplay="SELECT NAME, ACC_ID FROM t_acc_type_master where ID="+mast.getAccType()+" AND ACC_ID="+mast.getAcc()+"";
      ...
      <div class="alert alert-info">
                        ...
                        <hr>
                            ...
                            <div class="form-group">
                                    ...
                                    <label for="focusedinput" class="col-sm-2 control-label">Name of Accessory Type</label>
                                    <div class="col-sm-4">
