       ...
       <div class="col_1">
		   <div class="col-md-10 span_3">
		    <div class="bs-example1" data-example-id="contextual-table">
                   ...
                   <h4 class="panel-title">Online Queries Recevied through Website</h4><br>
               
                    <%
                    
                    String sql= "SELECT ID, NAME,EMAIL, SUBJECT,DESCRIPTION, "+
                    " DATE_FORMAT(UPLOAD_DATE,'%d-%b-%Y') UPLOAD_DATE "+
                    " FROM t_contact order by UPLOAD_DATE DESC";
                   // out.println(sql);
                    int count=1;
		      ...
		      <tbody>
                      <%
                       ...
                       sub= rs.getString("SUBJECT");if(sub==null)sub="";
                       desc= rs.getString("DESCRIPTION");if(desc==null)desc="";
                       email= rs.getString("EMAIL");if(email==null)email="";
                       uploadDate= rs.getString("UPLOAD_DATE");if(uploadDate==null)uploadDate="";
