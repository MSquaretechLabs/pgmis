...
// out.println(display);
 if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlInsert="INSERT INTO t_style_details(ID,STYLE_ID,PRINT_POSITION, ES,S,M,L,XL,XXL,REMARKS)"+
      " VALUES "+
     " ("+maxId+","+style+",'"+printPos+"', "+esTemp+","+sTemp+","+mTemp+","+lTemp+","+xlTemp+","+xxlTemp+",'"+remarks+"')"; 
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Add Positions Details in Style/Sample</h4>
                </div>
                <%
...
<div class="form-group">                        
    <div class="col-md-12 span_3">
		  <div class="bs-example1" data-example-id="contextual-table">
           ...
           String  sql =" SELECT SD.PRINT_POSITION, "+
