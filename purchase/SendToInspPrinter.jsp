     ...
     <!-- Navigation -->
      ...
      <div class="col_1">
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SendToDyer" action="SendToInspPrinterDetail.jsp">
      ...
      float QtyOrdered=0,qtySent=0,qtyRcvd =0,qtySentToInsp=0,qtyToBeSent=0,qtyShrink=0,qtyShrinkMtrs=0,qtyRj=0;;
      float qtyReady =0;
...
<%
  ...
  " and pd.STATUS='R' and pd.TYPE_CHECK='Print'  "+
		  ...
		  <div class="bs-example1" data-example-id="contextual-table" style='overflow-x:scroll;overflow-y:hidden;width:1150x;'>
		        ...
		        <tr>
		          ...
		          <th>Fabric & Variety</th>
                         ...
                         <th>Qty. Rejected (r)</th>
                          ...
                          <th>Total Qty. to be sent (c=a-b+r)</th>
		      ...
		      <tbody>
		          ...
		          <td align=right><%=QtyOrdered%></td>
                         ...
                         <td align=left><a href="ClosePurchase.jsp?dpId=<%=dpId%>&report=printer&type=inspected">Close</a></td>
