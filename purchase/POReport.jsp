      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">PO Detail Report</h4>
                </div>
                <%
...
<div class="form-group">                        
    <div class="col-md-12 span_4">
     ...
     <tr><td valign=top nowrap=nowrap>
      <b> Quantity Sent to Dyers/Printers</b>
      </td> 
       </tr>
     <tr> 
     <td colspan=2>
     <%
           ...
           String poDpDtlId="0",poDtlId="0",sql2="";
           float qtyShrinkTotal=0;
           boolean dataAvail= false;
           cnt=0;
           sql = "SELECT p.ID PO_DTL_ID,pd.ID PO_DP_DTL_ID,fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,d.NAME DYER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_SHRINK_PRSNT,"+
          " ifnull(pd.QTY_SENT_TO_INSP,0) QTY_SENT_TO_INSP,ifnull(pd.QTY_SHRINK,0) QTY_SHRINK,"+
          ...
          " and pd.TYPE_CHECK='Plain' and p.PO_ID="+mast.getPo()+"";
            ...
            rs = st.executeQuery(sql);
		      ...
		      <tbody>
		        ...
		        <!--  <td align=right><%=QtyOrdered%></td>-->
                      ...
                      %>
                      <tr scope="row" class="warning">
		          <th scope="row" colspan=4><b>Total</th>
		          <td align=CENTER><b><%=forNum.returnFormat2(qtySentTotalTemp)%></td>
		          
                           <td></td> <td align=CENTER><b><%=forNum.returnFormat2(qtyShrinkTotal)%></td>
                           <td></td> 
