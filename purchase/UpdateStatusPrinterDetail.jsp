...
function validateFormFields()
{
 ...
 if(document.SendToPrinter.display.value != "display")
 {
   ...
   var qtyReadyN= Number(document.SendToPrinter.qtyReady.value);
   var qtyToBeReadyN= Number(document.SendToPrinter.qtyToBeReady.value);
   
   if(document.SendToPrinter.qtyReady.value=="")
   {
   reason+="Please enter Qty \n";
   }else if(qtyReadyN>qtyToBeReadyN)
   {
   reason+="Qty Ready value Invalid. Please enter correct value\n";
   }
   if (reason != "") {
...
{   
  ...
  if(display.equalsIgnoreCase("save"))
 {
     ...
     String qtyReady=request.getParameter("qtyReady"); if(qtyReady==null)qtyReady="0";
    // String remarks=request.getParameter("remarks"); if(remarks==null)remarks="";
     ...
     String qtyShrinkMtrs= request.getParameter("qtyShrinkMtrs"); if(qtyShrinkMtrs==null)qtyShrinkMtrs="0";
      String qtyReadyS= request.getParameter("qtyReadyS"); if(qtyReadyS==null)qtyReadyS="0";
     
     
     float qtyOrderedInt=0,qtyReadySUpdate=0;
    // out.println(qtyOrdered);
          ...
          if(qtyReadyS.equalsIgnoreCase("")|| qtyReadyS.equalsIgnoreCase("0"))
          {
          
                      try{
                        qtyReadySUpdate= Float.parseFloat(qtyShrinkMtrs)+Float.parseFloat(qtyReady);
                        }catch(Exception rt){
                        qtyReadySUpdate=0;
                        }
          }else {
          ...
          try{
                        qtyReadySUpdate= Float.parseFloat(qtyReadyS)+Float.parseFloat(qtyReady);
                        }catch(Exception rt){
                        qtyReadySUpdate=0;
                        }
      ...
      String sqlUpdate="UPDATE t_po_dp_details set "+
     " QTY_READY=ifnull(QTY_READY,0)+"+qtyReady+",QTY_READY_S="+qtyReadySUpdate+"   where id="+dpId+"";
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                  <h1>
                    <span class="label btn_6 label-success">Update Printing Status</span>  
                    </h1>
                </div>
                <%
      ...
      String dtlSql1="";
      String fabName="",varName="",remarks="",sentDate="",rcvdDate="",printName="",varId="0";
      float QtyOrdered=0,qtySent=0,qtyRcvd=0,qtyReady=0,qtyReadyS=0,qtyToBeReady=0,qtySentToInsp=0,qtyToBeSent=0,qtyShrink=0,qtyShrinkMtrs=0,qtyRj=0;
...
<%
  ...
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,printer.NAME PRINTER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_RCVD,ifnull(pd.QTY_SHRINK_PRSNT,0) QTY_SHRINK_PRSNT,ifnull(pd.QTY_RJ,0) QTY_RJ,ifnull(pd.QTY_READY_S,0) QTY_READY_S,"+
  " DATE_FORMAT(M_SENT_DATE,'%d-%b-%Y') M_SENT_DATE,DATE_FORMAT(M_RCVD_DATE,'%d-%b-%Y') M_RCVD_DATE,ifnull(pd.QTY_READY,0) QTY_READY,"+
  " SUPP_REMARKS, print.NAME PRINT , QTY_SENT_TO_INSP,(QTY_RCVD-QTY_SENT_TO_INSP) QTY_TO_BE_SENT"+
  ...
  " where pd.PO_DTL_ID= p.ID and p.PO_ID= pm.ID and pm.SUP_ID= s.ID AND p.VAR_ID= var.ID and var.FABRIC_ID= fab.ID  and pd.TYPE_ID= print.ID and pd.DP_ID= printer.ID"+
  " and pd.STATUS='R' and pd.TYPE_CHECK='Print'   and pd.ID="+dpId+" order by pd.M_SENT_DATE ASC";
    //out.println(dtlSql1);
    ...
    String remarks2="",dyerRemarks="";
                       ...
                       if(rs.next())
                       {
                        ...
                        qtyReady= rs.getFloat("QTY_READY");
                         qtyReadyS= rs.getFloat("QTY_READY_S");
                        ...
                        try{
                        qtyToBeReady= qtyRcvd-qtyShrinkMtrs-qtyReady+qtyRj;
                        }catch(Exception rt){
                        qtyToBeReady=0;
                        }
                       ...
                       %>
                             ...
                             <div class="form-group"> 
                                    ...
                                    <input type="HIDDEN" name="qtyReadyS" value="<%=qtyReadyS%>"></input>
                            ...
                            <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty. Received : </b><%= qtyRcvd%></label>
                                    <label for="selector1" class="col-sm-4 control-label"><b>Date on which material was received: </b><%=rcvdDate%></label>
                              ...
                              <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Shrink Qty. (in %): </b><%= qtyShrink%></label>
                                    <label for="selector1" class="col-sm-4 control-label"><b>Shrink Qty. (in meters)(b): </b><%=qtyShrinkMtrs%>
                                    <input type=hidden name="qtyShrinkMtrs" value="<%=qtyShrinkMtrs%>"></input>
                                    </label>
                               ...
                               <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty. already sent for inspection (c): </b><%= qtySentToInsp%></label>
                                    <label for="selector1" class="col-sm-4 control-label"><b>Rejected Qty. (r): </b><%=qtyRj%></label>
                            ...
                            <div class="form-group">
                                    ...
                                    <div class="col-sm-1">
                                             ...
                                             <input type="text" size=2 class="form-control1" name="xyz" readonly value= "<%=qtyToBeSent%>" >
                                    </div>
                            </div>
                            
                            <div class="form-group">
                          
                                    <label for="selector1" class="col-sm-2 control-label">Qty. Ready (already recorded)</label>
                                    <div class="col-sm-1">
                                            
                                             <input type="text" size=2 class="form-control1" name="prvsQtyReady" readonly value= "<%=qtyReady%>" id="prvsQtyReady">
                                    </div>
                            </div>
                            <div class="form-group">
                          
                                    <label for="selector1" class="col-sm-2 control-label">Qty. to be ready</label>
                                    <div class="col-sm-1">
                                            
                                             <input type="text" size=2 class="form-control1" name="qtyToBeReady" readonly value= "<%=qtyToBeReady%>" id="prvsQtyReady">
                                    </div>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Qty (in mtrs) ready</label>
                                    <div class="col-sm-2">
                                            <input type="text" size=2 class="form-control1" name="qtyReady" id="qtyReady" placeholder="Qty">
                                    </div>
                            ...
                            <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_8 btn-lg btn-warning warning_11" onclick="document.location.href='UpdateStatusPrinter.jsp'" >Back </button> 
                                 </p>
                            </div>
