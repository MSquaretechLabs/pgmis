...
function validateFormFields()
{
 ...
 if(document.SendToDyer.display.value != "display")
 {
   ...
   var qtyToBeReadyN= Number(document.SendToDyer.qtyToBeReady.value);
   
   if(document.SendToDyer.qtyReady.value=="")
   {
    ...
    // String qtySent=request.getParameter("qtySent"); if(qtySent==null)qtySent="0";
     ...
     //out.println(qtyReadyS);
          ...
          if(qtyReadyS.equalsIgnoreCase("")|| qtyReadyS.equalsIgnoreCase("0"))
          {
                      ...
                      try{
                        qtyReadySUpdate= Float.parseFloat(qtyReady);
                        }catch(Exception rt){
                        qtyReadySUpdate=0;
                        }
          }else {
          ...
          try{
           ...
           try{
                        qtyReadySUpdate= Float.parseFloat(qtyShrinkMtrs)+qtyReadySUpdate;
                        }catch(Exception rt){
                        qtyReadySUpdate=0;
                        }
...
<div id="wrapper">
     <!-- Navigation -->
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                  <h1>
                    <span class="label btn_6 label-success">Update Material Ready Status</span>  
                    </h1>
                </div>
                <%
      ...
      float QtyOrdered=0,qtySent=0,qtyRcvd=0,qtyReady=0,qtyReadyS=0,qtyRj=0,qtyToBeReady=0,qtySentToInsp=0,qtyToBeSent=0,qtyShrink=0,qtyShrinkMtrs=0;
...
<%
  ...
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,d.NAME DYER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_RCVD,ifnull(pd.QTY_SHRINK_PRSNT,0) QTY_SHRINK_PRSNT,ifnull(pd.QTY_RJ,0) QTY_RJ,ifnull(pd.QTY_READY_S,0) QTY_READY_S,"+
                       ...
                       %>
                            ...
                            <div class="form-group"> 
                              ...
                              <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Actual Shrink Qty. (in meters)(c): </b><%=qtyShrinkMtrs%></label>
                        ...
                        <div class="form-group">
                            ...
                            <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_8 btn-lg btn-warning warning_11" onclick="document.location.href='UpdateStatusDyer.jsp'" >Back </button> 
                                 </p>
                            </div>
