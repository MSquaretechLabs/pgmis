...
<meta name="viewport" content="widthf=device-width, initial-scale=1">
     ...
     <!-- Navigation -->
      ...
      <div class="col_1">
		 ...
		 <div class="tab-pane active" id="horizontal-form">
                    <form class="form-horizontal" name="SendToDyer" action="UpdateStatusPrinterDetail.jsp">
      ...
      String dtlSql1="",dpId="";
      String fabName="",varName="",remarks="",sentDate="",rcvdDate="",dyerRemarks="",printName="",varId="0";
...
<%
  ...
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,printer.NAME PRINTER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_RCVD,ifnull(pd.QTY_SHRINK_PRSNT,0) QTY_SHRINK_PRSNT,ifnull(pd.QTY_RJ,0) QTY_RJ,"+
  " DATE_FORMAT(M_SENT_DATE,'%d-%b-%Y') M_SENT_DATE,DATE_FORMAT(M_RCVD_DATE,'%d-%b-%Y') M_RCVD_DATE,"+
  " SUPP_REMARKS, print.NAME PRINT , QTY_SENT_TO_INSP,ifnull(QTY_SHRINK,0)QTY_SHRINK,ifnull(QTY_READY,0)QTY_READY,(QTY_RCVD-QTY_SENT_TO_INSP) QTY_TO_BE_SENT"+
  ...
  " and pd.STATUS='R' and pd.TYPE_CHECK='Print'  and pd.ALL_READY NOT IN ('Y') order by pd.M_SENT_DATE ASC";
   // out.println(dtlSql1);
		  ...
		  <div class="bs-example1" data-example-id="contextual-table" style='overflow-x:scroll;overflow-y:hidden;width:1150x;'>
		      ...
		      <tbody>
		          ...
		          <td align=right><%=QtyOrdered%></td>
                          ...
                          <td align=left><%=qtyShrinkMtrs%></td> 
                           ...
                           <td align=left><a href="ClosePurchase.jsp?dpId=<%=dpId%>&report=printer&type=ready">Close</a></td>
