      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Dyer Issue Report</h4>
                </div>
                <%
...
<div class="form-group">                        
    <div class="col-md-12 span_4">
      ...
      <table width=90%>
       ...
       <tr><td valign=top nowrap=nowrap align=center colspan=2><b> Dyer Issue Report<br><br> </b></th>
     ...
     <tr><td valign=top nowrap=nowrap>
      <b> Quantity Sent to Dyer:-<%=dyerNameD%></b>
      </td> 
       </tr>
     <tr> 
     <td colspan=2>
