...
{   
  ...
  if(display.equalsIgnoreCase("save"))
 {
     ...
     String sqlUpdate="UPDATE t_po_dp_details set QTY_RCVD= QTY_SENT,M_RCVD_DATE='"+rcvdDate+"' ,"+
     " STATUS='R' where id="+dpId+"";
    // out.println(sqlUpdate);
    
     int x=st.executeUpdate(sqlUpdate);
     message= "Material has been received at Printer successfully.";
  }
...
<%
    int count=1;
    int cnt=0;
    String trClass="info", poNo="",dyerRemarks="";
    
    // get var id
    
   
  dtlSql1 = "SELECT concat(pm.PO_NO,'-',s.NAME,'-dated.',DATE_FORMAT(PO_DATE,'%d-%b-%Y')) PO_NO, "+
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,print.NAME PRINTER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_SHRINK_PRSNT,"+
  " DATE_FORMAT(M_SENT_DATE,'%d-%b-%Y') M_SENT_DATE,SUPP_REMARKS, print.NAME PRINT "+
  " FROM t_po_master pm, t_supplier_master s,t_po_details p, t_po_dp_details pd, t_fabric_master fab, t_var_master var, t_print_master print,t_printer_master printer"+
  ...
  " and pd.STATUS='S' and pd.TYPE_CHECK='Print' and pd.ID="+dpId+" order by pd.M_SENT_DATE ASC";
    //out.println(dtlSql1);
    ...
    String remarks2="";
                       ...
                       %>
                              ...
                              <div class="form-group"> 
                                ...
                                <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty. As per PO: </b><%=QtyOrdered%></label>
                            ...
                            <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty. to be received for Printing : </b><%= qtySent%></label>
                             ...
                             <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty Sent on : </b><%= sentDate%></label>
                                    <label for="selector1" class="col-sm-4 control-label"><b>Remarks: </b><%=remarks2%></label>
                       ...
                       <div class="form-group">
                                    ...
                                    <label for="selector1" class="col-sm-2 control-label">Date of Material Received at Printer </label>
                                    <div class="col-sm-4">
                       ...
                       <div class="form-group">
                            ...
                            <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_8 btn-lg btn-warning warning_11" onclick="document.location.href='ReceiveAtPrinter.jsp'" >Back </button> 
                                 </p>
                            </div>
