      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                    <h4 class="panel-title">Dyer Job Order  Report</h4>
                </div>
                <%
...
if(!mast.getDyer().equalsIgnoreCase("0")){ 
  ...
  dtlSql = "SELECT A.ID,  A.PO_NO PO_NO , A.SUP_ID ,DATE_FORMAT(PO_DATE,'%d-%b-%Y') PO_DATE ,CREATED_BY,BOOK_NO"+ 
   ...
   String dyerNameD="";
    String dSql="SELECT NAME FROM t_dyer_master where ID="+mast.getDyer()+"";
           rs = st.executeQuery(dSql);
           if(rs.next())
           {
           dyerNameD=rs.getString("NAME");if(dyerNameD==null)dyerNameD="";
...
<div class="form-group">                        
    <div class="col-md-12 span_4">
      ...
      <table width=90%>
       ...
       <tr><td valign=top nowrap=nowrap align=center colspan=2><b> JOB Order Issue Report<br><br> </b></th>
     ...
     <tr><td valign=top nowrap=nowrap><br><br>
      <b>Dyer</b>:-<%=dyerNameD%></b>
      </td> 
       </tr>
     <tr> 
     <td colspan=2>
     <%
           ...
           String poDpDtlId="0",poDtlId="0",sql2="",mtrCharge="",image="";;
          ...
          " ifnull(pd.QTY_SENT_TO_INSP,0) QTY_SENT_TO_INSP,ifnull(pd.QTY_SHRINK,0) QTY_SHRINK, MTR_CHARGE,plain.IMAGE,"+
          ...
          " and pd.TYPE_CHECK='Plain' and p.PO_ID="+mast.getPo()+" AND pd.DP_ID="+mast.getDyer()+"";
          /* 
