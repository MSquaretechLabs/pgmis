      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                  <h1>
                    <span class="label btn_6 label-success">Receive Material At Dyer</span>  
                    </h1>
                </div>
                <%
               ...
               <h1>
           		  ...
           		  <div class="bs-example1" data-example-id="contextual-table" align=left>
		     <div class="tab-pane active" id="horizontal-form" align=left>
...
<%
  ...
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,d.NAME DYER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_SHRINK_PRSNT,"+
  ...
  " and pd.STATUS='S' and pd.TYPE_CHECK='Plain' and pd.ID="+dpId+" order by pd.M_SENT_DATE ASC";
    //out.println(dtlSql1);
    ...
    String remarks2="";
                       ...
                       %>
                            ...
                            <div class="form-group"> 
                                    ...
                                    <label for="selector1" class="col-sm-4 control-label"><b>Qty. to be received for Dyeing: </b><%= qtySent%></label>
