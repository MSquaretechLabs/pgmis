...
function validateFormFields()
{
 ...
 if(document.SendToPrinter.display.value != "display")
 {
   ...
   var qtyAlreadySent= Number(document.SendToPrinter.qtySentToInsp.value);
   var qtySentN= Number(document.SendToPrinter.qtySent.value);
   var QtySentT= qtyAlreadySent+qtySentN;
   
   if(document.SendToPrinter.sentDate.value=="")
   {
      ...
      <div class="col_1">
		   <div class="col-md-12 span_6">
                 <div class="panel-heading">
                  <h1>
                    <span class="label btn_6 label-success">Receive Material from Printer</span>  
                    </h1>
                </div>
                <%
...
<%
  ...
  " fab.NAME FABRIC_NAME,var.ID VAR_ID,var.NAME VAR_NAME,printer.NAME PRINTER_NAME,p.QTY, pd.QTY_SENT,pd.QTY_RCVD,ifnull(pd.QTY_SHRINK_PRSNT,0) QTY_SHRINK_PRSNT,ifnull(pd.QTY_READY,0) QTY_READY,ifnull(pd.QTY_RJ,0) QTY_RJ,"+
  " DATE_FORMAT(M_SENT_DATE,'%d-%b-%Y') M_SENT_DATE,DATE_FORMAT(M_RCVD_DATE,'%d-%b-%Y') M_RCVD_DATE,"+
  " SUPP_REMARKS, print.NAME PRINT , QTY_SENT_TO_INSP,ifnull(QTY_SHRINK,0) QTY_SHRINK, (QTY_RCVD-QTY_SENT_TO_INSP) QTY_TO_BE_SENT"+
                       ...
                       */
                       ...
                       <div class="form-group">
                            ...
                            <div class="but_list" align=center>
                                 ...
                                 <button type="button" class="btn btn_8 btn-lg btn-warning warning_11" onclick="document.location.href='SendToInspPrinter.jsp'">Back </button> 
                                 </p>
                            </div>
